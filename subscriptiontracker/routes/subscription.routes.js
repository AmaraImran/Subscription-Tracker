...
import { cancelSubscription, createsubscription, deletesubscription, getsubscription, getSubscriptionByid, getUpcomingRenewals, updateSubscription } from "../controllers/subscription.controller.js";
...
subscriptionrouter.get("/user/:id", AuthorizationMiddleware,getsubscription);
